...
If unset, the default is `true` outside the EU and `false` otherwise.
...
| `analytics`                                      | boolean                                                           | Enable analytics events. When unset, the default is `false` for EU users and `true` otherwise.                                  |
